...
with col1:
    if st.button("🏠 Home", use_container_width=True, key="signup_home_btn"):
        st.switch_page("app.py")

with col2:
    if st.button("📋 FTC Rules", use_container_width=True, key="signup_rules_btn"):
        st.switch_page("app.py")

with col3:
    if st.button("🎓 Tutorials", use_container_width=True, key="signup_tutorials_btn"):
        st.switch_page("app.py")
